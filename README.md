...
[![License MIT](https://img.shields.io/badge/license-MIT-blue.svg?style=flat)](https://github.com/BenjaminLiu921/BenjaminLiu921.github.io/blob/master/LICENSE)
...
>
### [查看博客戳这里 👆](https://benjaminliu921.github.io/)
...
我的博客标题是 **“My Blog”** 但是我想要在搜索的时候显示 **“柏荧的博客 | BY Blog”** ，这个就需要 SEO Title 来定义了。
...
遵循 MIT 许可证。有关详细,请参阅 [LICENSE](https://github.com/BenjaminLiu921/benjaminliu921.github.io/blob/master/LICENSE)。
